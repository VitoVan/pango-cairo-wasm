...
int main(int argc, char *argv[]) {
  ...
  SDL_Window *window =
      SDL_CreateWindow("PangoCairo in an SDL2 window", SDL_WINDOWPOS_UNDEFINED,
  ...
  pango_layout_set_markup(layout,
                          "<span foreground='white' background='black'><i> "
                          "Hello </i></span>, <span foreground='blue' "
                          "size='x-large'>pango</span><span foreground='red' "
                          "size='large'>markup</span>",
                          -1);

  cairo_set_source_rgb(cr, 1, 1, 1.0);
  cairo_move_to(cr, 50, 50.0);
